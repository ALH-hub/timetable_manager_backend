    ...
    try:
        ...
        return jsonify({
            'slots': [{
                ...
                'level_id': slot.course.level_id,
                'level_name': slot.course.level.name if slot.course.level else None,
                'level_code': slot.course.level.code if slot.course.level else None,
